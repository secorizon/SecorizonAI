...
func completedTaskReportFooter(now time.Time, elapsed time.Duration) string {
...
func main() {
	...
	for {
		...
		// Measure end-to-end wall time for the report generated by this task turn.
		// This deliberately includes model inference, commands/searches, network
		// waits, and time spent at confirmation prompts: it is the duration the
		// user experienced from submission until the completed deliverable.
